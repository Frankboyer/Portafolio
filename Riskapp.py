...
import json
import os
from typing import Dict, List, Tuple, Any # Para type hinting

# --- 1. Módulo: data_config.py ---
"""
...
tablas base para el modelo determinista y Monte Carlo, y textos multilenguaje.
"""
...
PERFILES_BASE = {
    "Seguridad Patrimonial": {
        ...
        "subcategorias": {
            "Físico": ["Robo", "Intrusión", "Sabotaje", "Vandalismo"], "Humano": ["Acceso no autorizado", "Error humano", "Amenaza interna"],
    ...
    "Gestión de Proyectos": {
        "categorias": {
            ...
            "Costo": {"weight": 15, "impacts": {"Económico": 25, "Financiero": 10}},
...
# --- Mapeos para obtener valores numéricos de clasificaciones ---
# Estos se usarán en calculations.py para convertir clasificaciones a factores (0-1)
